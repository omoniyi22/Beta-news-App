...
// Update a SinglePost
router.post('/update/politics/:id', (req, res) => {
...
//Delete any Politics
router.get('/delete/politics/:id', (req, res) => {
...
//Deleting a Comment
router.post('/comment/politics/:id', (req, resp) => {
...
router.post('/views/politics/:id', (req, res) => {
...
router.post('/delete/views/politics/:id', (req, res) => {
