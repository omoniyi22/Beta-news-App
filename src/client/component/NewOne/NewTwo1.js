			...
			<div className='row border p-3'>
				<div className='col-md-12 mb-5'>
						...
						<div className='col-md-12 p-0'>
							<div className=''>
								...
								<span className='float-right small my-1'>
									...
									4
									'>
									<a href='#politic' data-toggle='tab' className='text-danger'>
									<span className="text-danger small "> Politics</span>
									</a></span>
									<span className='z-depth-1 btn btn-sm px-2 py-1 mt-0 text-danger mx-2 link mb-
									4
									'>
									<a href='#foreign' data-toggle='tab' className='text-danger'>
					...
					<div id='myTabContent' className='tab-content row Second1 mt-3'>
						...
						<div className="tab-pane active col-12" id="sport" >
						<div className="row" >
					...
					<div className="tab-pane fade col-12" id="politic" >
						<div className="row" >
					...
					<div className="tab-pane fade  col-12" id="foreign" >
						<div className="row" >
